      ...
      <div class="row">
        <div class="col-md-3">
          <div class="form-group">
            <input type="date" name="dari_tgl" id="date" class="form-control">
          </div>
        </div>
        <label for="dari_tgl" class="mt-2">S/D</label>
        <div class="col-md-3">
          <div class="form-group">
            <input type="date" name="sampai_tgl" id="date" class="form-control">
          </div>
        </div>
        <div class="">
