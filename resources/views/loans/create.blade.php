                        ...
                        <form method="POST" action="{{route('loans.kalkulasi', $type->id)}}">
                            ...
                            <div class="input-group mb-4 shadow-sm">
                                ...
                                <input type="text"
                                       ...
                                       id="jumlah_pinjaman"
                                       class="form-control border-0 text-muted {{ $errors->has('jumlah_pinjaman') ? ' is-invalid' : '' }}"
                            ...
                            <div class="input-group mb-4 mt-3 shadow-sm">
                                ...
                                <input type="text"
                                       name="lama_angsuran"
                                       id="lama_angsuran"
                                       class="form-control border-0 text-muted {{ $errors->has('lama_angsuran') ? ' is-invalid' : '' }}"
                                       value="{{old('lama_angsuran')}}">

                                @if ($errors->has('lama_angsuran'))
                                    <span class="invalid-feedback pl-5" role="alert">
                                        <strong>{{ $errors->first('lama_angsuran') }}</strong>
                                    </span>   
                                @endif
